...
<div class="container">
    <div class="row mb-n3">
        <div class="col-6">
            ...
            <img src="views/common/imgs/departament.png" id="img_dep" alt="">
...
<nav class="navbar navbar-expand-md navbar-light barraLog" style="background-color: #4E006D" ;>
    ...
    <div class="collapse navbar-collapse" id="desple">
        <a class="navbar-brand text-light" id="sonfe_text" href="index.php">IES SON FERRER</a>
        ...
        <form class="form-inline my-2 my-lg-0" action="search.php" method="post">
            <input class="form-control mr-sm-4" id="search" onkeyup="yesTwo()" name="item" type="search"
                   placeholder="Curso, Materia.." aria-label="Search" hidden>
...
<div class="container-fluid bg-light" style="border-bottom: 1px solid #4E006D;">
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            <img src="views/common/imgs/niños-estudiando.jpg" id="img_ninios" class="mb-1 float-right"
                 alt="niños">
        </div>
    </div>
</div>
